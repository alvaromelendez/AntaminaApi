...
namespace GMM.Application.Interfaces.Repositories 
{
    ...
    public interface IGenericRepository<TEntity> where TEntity : class, IGenerateEntity<TEntity>
    {
        ...
        /// <summary>
        /// Ejecuta una sentencia select SQL y lo convierte a la entidad solicitada.
        /// </summary>
        /// <param name="query">Sentencia SQL</param>
        /// <param name="parameters">Parametros opcionales separados por comas</param>
        /// <returns></returns>
        IQueryable<TEntity> Query(string query, params object[] parameters);
        ...
        /// <param name="parameters">Parametros opcionales separados por comas</param>
        /// <returns></returns>
        IQueryable<TEntity> QueryAsNoTracking(string query, params object[] parameters);
